# Real-time face descriptor computing

import dlib
import cv2
import time

# 1. Dlib frontal face detector
detector = dlib.get_frontal_face_detector()

# 2. Dlib facial landmark detector
predictor = dlib.shape_predictor('data/data_dlib/shape_predictor_68_face_landmarks.dat')

# 3. Dlib Resnet Face recognition model, extraction 128D eigenvector
